...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <h1 class="page-header"> Ezzat News <small> Add New Post </small> </h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                if (isset($_POST['add_post'])) {
                    ...
                    (`post_title`, `post_category`, `post_author`, `post_date`, `post_image`, `post_content`, `post_tags`) 
                    VALUES 
                    ('$post_title','$post_category','$post_author','$post_date','$post_image_name','$post_content','$post_tags')";
